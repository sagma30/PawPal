...
export const AdminPortal: React.FC<AdminPortalProps> = ({
  ...
  const handleSaveNewUser = (newUserPartial: Partial<AdminUser>) => {
    ...
    const completeUser: AdminUser = {
      ...
      location: newUserPartial.location || 'Mumbai',
      primaryAddress: newUserPartial.primaryAddress || 'Mumbai, India',
      joinedDate: 'Just now',
        ...
        <main className="flex-grow pb-16">
          ...
          {['pets', 'providers', 'bookings', 'payments', 'insurance', 'reviews', 'complaints', 'analytics', 'settings'].includes(
            ...
            <div className="p-6 md:p-8 max-w-7xl mx-auto space-y-6">
                  ...
                  {users
                    ...
                    .map((pet) => (
                      ...
                      >
                        ...
                        />
                        <div>
                          <h4 className="font-bold text-sm text-[#1b1c1a]">{pet.name}</h4>
                          <p className="text-xs text-[#877462]">
                            {pet.breed} • {pet.age}
                          </p>
                        </div>
              ...
              {['bookings', 'payments', 'insurance', 'reviews', 'complaints', 'analytics', 'settings'].includes(
                currentTab
              ) && (
